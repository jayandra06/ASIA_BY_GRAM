        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex gap-2 border-b border-zinc-200">
                <button
                    ...
                    className={`px-4 py-2.5 text-sm font-bold transition-colors border-b-2 -mb-px ${activeTab === 'ads'
                ...
                <button
                    ...
                    className={`px-4 py-2.5 text-sm font-bold transition-colors border-b-2 -mb-px ${activeTab === 'leads'
                            ? 'border-primary text-zinc-900'
                            : 'border-transparent text-zinc-400 hover:text-zinc-700'
                        }`}
                >
                                        ...
                                        <tr key={ad._id} className="hover:bg-zinc-50 transition-colors">
                                            ...
                                            <td className="p-4">
                                                <button
                                                    ...
                                                    className={`px-2 py-1 rounded text-xs font-bold uppercase tracking-wider ${ad.status === 'published'
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 h-full lg:overflow-hidden">
                                            ...
                                            <div className={`${cardClass} lg:overflow-hidden lg:min-h-0`}>
                                                ...
                                                <div className="grid grid-cols-1 min-[420px]:grid-cols-2 gap-2.5">
                                                    ...
                                                    <div>
                                                        <label className={labelClass}>Prize / Reward Pool</label>
                                                        <input
                                                            name="prize"
