...
"[project]/app/api/menu/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (menuCache && now - cacheTimestamp < CACHE_DURATION) {
            ...
            const filteredData = category ? menuCache.filter((item)=>item.category === category) : menuCache;
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Menu$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(filters).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e07a8224._.js.map